...
public class SendMail {
    ...
    public static String sendEmailAccount = "anguodong000@163.com";

    /**
     * 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
      */
    public static String sendEmailPassword = "UMRWFZAZQXEPYEEK";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailContent) throws Exception {
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "配齐网平台", "UTF-8"));

        // 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "尊敬的用户", "UTF-8"));

        // 设置邮件主题
        message.setSubject("配齐网密码找回", "UTF-8");
